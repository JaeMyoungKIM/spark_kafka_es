...
# 앞서 만든 Spark Context를 이용하여 
# StreamingContext가 1초마다 batch작업을 하도록 생성합니다.
ssc = StreamingContext(sc, 1)
 
# TCP socket stream으로 구성된 Discretized Stream을 생성합니다. 
# sys.argv[1], [2] 에는 host, port가 들어갑니다.
# 결과적으로 host:port로 socket연결을 하고 스트림을 생성하게 됩니다. 
# (먼저 포트가 열려 있어야겠죠!?)
